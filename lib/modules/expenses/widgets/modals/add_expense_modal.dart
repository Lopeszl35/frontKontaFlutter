...
class _AddExpenseModalState extends State<AddExpenseModal> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // Isso faz o Scaffold redimensionar a área quando o teclado abre
      resizeToAvoidBottomInset: true, 
      body: Align(
        alignment: Alignment.bottomCenter,
        child: Container(
          // CORREÇÃO AQUI: Removemos o cálculo manual de viewInsets.
          // Usamos apenas um padding fixo, pois o Scaffold já empurra o conteúdo.
          ...
          child: SingleChildScrollView(
            // Importante: garante que o conteúdo role se o teclado cobrir muito espaço
            child: Column(
                          ...
                          child: DropdownButton<String>(
                            ...
                            onChanged: (String? newValue) async {
                              ...
                              if (newValue == 'CREDITO') {
                                ...
                                await ctrl.fetchCards(user.token!, user.id);
                                
                                if (ctrl.userCards.isEmpty && mounted) {
                                  _showNoCardDialog();
                                } else if (ctrl.userCards.isNotEmpty && mounted) {
                                  setState(() {
                                    selectedCardUuid = ctrl.userCards.first.uuid;
                                  });
                                }
                              }
                            },
                ...
                if (selectedPayment == 'CREDITO') ...[
                  ...
                  Consumer<VariableExpensesController>(
                    builder: (context, ctrl, _) {
                      if (ctrl.userCards.isEmpty) return const SizedBox.shrink();
                      ...
                      return Container(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton<String>(
                            ...
                            style: const TextStyle(color: AppTheme.textWhite),
                            onChanged: (String? newValue) => setState(() => selectedCardUuid = newValue),
                            items: ctrl.userCards.map<DropdownMenuItem<String>>((CreditCardModel card) {
                              return DropdownMenuItem<String>(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text("${card.nome} (Final ${card.ultimos4})")
                                  ]
                                ),
                              );
                            }).toList(),
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          TextButton(
            onPressed: () {
              Navigator.pop(ctx);
              setState(() => selectedPayment = 'DINHEIRO');
            },
  ...
  Future<void> _handleSave(VariableExpensesController controller, dynamic user) async {
