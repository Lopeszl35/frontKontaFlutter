...
class _LoginPageState extends State<LoginPage> {
      ...
      if (sucesso) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            backgroundColor: AppTheme.neonRed, // Erro Neon
              ...
              Container(
                ...
                decoration: const BoxDecoration(
                  ...
                  borderRadius: BorderRadius.only(
                    ...
                    bottomRight: Radius.circular(60), // Simetria moderna
                  ),
                  boxShadow: [
                          ...
                          children: [
                            ...
                            GestureDetector(
                              ...
                              child: const Text(
                                "Cadastre-se",
                                style: TextStyle(
                                  color: AppTheme.neonBlue, // Neon Blue para destaque
                                  fontWeight: FontWeight.bold,
                                ),
                              ),
                            ),
  ...
  Widget _buildModernInput({
    ...
    return TextFormField(
      ...
      validator: validator,
      style: const TextStyle(fontWeight: FontWeight.w500, color: AppTheme.textWhite), // Texto branco
      decoration: InputDecoration(
        ...
        enabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(16),
          borderSide: const BorderSide(color: AppTheme.borderDark), // Borda sutil inativa
        ),
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(16),
          borderSide: const BorderSide(color: AppTheme.primaryModern, width: 2), // Borda neon ativa
        ),
